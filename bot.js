...
// === KONTROLA ENV (doporučeno) ===
if (!BOT_TOKEN) throw new Error('❌ BOT_TOKEN není nastaven v ENV');
if (!BASE44_API_URL) throw new Error('❌ BASE44_API_URL není nastaven v ENV');
if (!BASE44_SERVICE_KEY) throw new Error('❌ BASE44_SERVICE_KEY není nastaven v ENV');
